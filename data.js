...
"SV2D クレイバースト": {
 ...
 "SV6a ナイトワンダラー": {
  ...
  "プロモ・限定カード": {
  "AR仕様": [
    "001/SV-P ピカチュウ (AR仕様｜スカーレット・バイオレット早期購入特典)",
    "048/SV-P ミライドン (AR仕様｜トリプレットビート シールド戦プロモカードパック)",
    "049/SV-P コライドン (AR仕様｜トリプレットビート シールド戦プロモカードパック)",
    "098/SV-P 名探偵ピカチュウ (AR仕様｜帰ってきた 名探偵ピカチュウ早期購入特典)",
    "218/SV-P ピカチュウ (AR仕様｜ポケカの夏がキタ！プロモカードGetキャンペーン)",
    "232/SV-P ナンジャモのカイデン (AR仕様｜バトルパートナーズ 1BOX購入特典)"
  ],
  "SAR仕様": [
    "WCS23 001/030 ピカチュウex (SAR仕様｜ポケモンWCS2023横浜 記念デッキ「ピカチュウ」収録)"
  ]
};
